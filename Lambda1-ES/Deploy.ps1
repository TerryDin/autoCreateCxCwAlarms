...
$Function = @{
  FunctionName = 'AutoCreateCloudWatchAlarms-ES_JVMMemoryPressure'
  Runtime = 'python3.8'
  Description = 'Auto create customized CloudWatch alarms for ES - JVMMemoryPressure. '
  ZipFilename = $ZipFileName
  Handler = 'index.handler'
  Role = 'arn:aws:iam::532134256174:role/lambdaExecRole-autoCreateCxCwAlarms_ES'
  Environment_Variable = @{
    MetricName = 'JVMMemoryPressure'
    MaxItems = '3'
    SNS_topic_suffix = 'ES_JVMMemoryPressure'
