...
$Function = @{
  FunctionName = 'AutoCreateCloudWatchAlarms-NLB_ActiveFlowCount'
  Runtime = 'python3.8'
  Description = 'Auto create customized CloudWatch alarms for NLB - ActiveFlowCount. '
  ...
  Environment_Variable = @{
    ...
    MaxItems = '3'
    SNS_topic_suffix = 'NLB_ActiveFlowCount'
