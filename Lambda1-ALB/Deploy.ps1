...
$Function = @{
  FunctionName = 'AutoCreateCloudWatchAlarms-ALB_HTTPCode_Target_5XX_Count'
  Runtime = 'python3.8'
  Description = 'Auto create customized CloudWatch alarms for ALB - HTTPCode_Target_5XX_Count. '
  ZipFilename = $ZipFileName
  Handler = 'index.handler'
  Role = 'arn:aws:iam::532134256174:role/lambdaExecRole-autoCreateCxCwAlarms_ELB'
  Environment_Variable = @{
    MetricName = 'HTTPCode_Target_5XX_Count'
    MaxItems = '3'
    SNS_topic_suffix = 'ALB_HTTPCode_Target_5XX_Count'
