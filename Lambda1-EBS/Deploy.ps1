...
$Function = @{
  FunctionName = 'AutoCreateCloudWatchAlarms-EBS_BurstBalance'
  Runtime = 'python3.8'
  Description = 'Auto create customized CloudWatch alarms for EBS - BurstBalance. '
  ZipFilename = $ZipFileName
  Handler = 'index.handler'
  Role = 'arn:aws:iam::532134256174:role/lambdaExecRole-autoCreateCxCwAlarms_EBS'
  Environment_Variable = @{
    MetricName = 'BurstBalance'
    MaxItems = '3'
    SNS_topic_suffix = 'EBS_BurstBalance'
